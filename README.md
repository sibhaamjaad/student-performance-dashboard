...
Built as part of my data analytics learning journey as a BS FinTech student at FAST NUCES CFD Campus.
...
| File | Description |
|------|-------------|
| `student_performance_dataset.xlsx` | Main file with raw data + dashboard |
...
Currently learning Power BI | Open to freelance data projects
